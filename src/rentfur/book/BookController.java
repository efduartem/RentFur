...
public class BookController {
    ...
    public static HashMap getInvoicetNum(){
        HashMap mapToReturn = new HashMap();
        ...
        try{
                ...
                if(rs.next()){
                    ...
                    mapToReturn.put("printer", rs.getString("printer"));
                    mapToReturn.put("number", rs.getInt("value"));
                    mapToReturn.put("fiscalStampNumber", rs.getInt("fiscal_stamp_number"));
                }
    ...
    public static HashMap getCreditNoteNum(){
        HashMap mapToReturn = new HashMap();
