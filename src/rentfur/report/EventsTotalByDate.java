 ...
 * @author FDuarte
 */
public class EventsTotalByDate extends JInternalFrame{
    ...
    public EventsTotalByDate(ReportController reportController){
...
//        });
        ...
        endDateLabel.setBounds(50,50, 120, 25);
...
//            
//        });
        endDateDatePicker.setBounds(200, 50, 160, 25);
        ...
        setResizable(true);
        setClosable(true);
        setTitle("Resumen de Eventos por Fecha");
    ...
    public void doDefaultCloseAction() {
        this.dispose();
        reportController.eventsTotalByDateViewClosed();
    }
    ...
    private void saveButtonAction(ActionEvent e) {
        ...
        if(initDate == null || endDate == null){
            ...
            reportController.executeEventsTotalByDateReport(initDate, endDate);
